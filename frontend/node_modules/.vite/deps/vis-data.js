...
function requireDefineProperty$5() {
  ...
  var $defineProperty = defineProperty$5.exports = function defineProperty2(it, key, desc) {
...
function requireObjectKeysInternal() {
  ...
  objectKeysInternal = function(object, names) {
    ...
    var result = [];
    var key;
    for (key in O) !hasOwn(hiddenKeys2, key) && hasOwn(O, key) && push2(result, key);
...
function requireEs_symbol_constructor() {
  ...
  var $getOwnPropertyNames = function getOwnPropertyNames(O) {
    ...
    $forEach(names, function(key) {
      if (!hasOwn(AllSymbols, key) && !hasOwn(hiddenKeys2, key)) push2(result, key);
    });
    return result;
  };
...
function requireEs_json_stringify() {
  ...
  var getReplacerFunction = function(replacer) {
    ...
    for (var i = 0; i < rawLength; i++) {
      ...
      else if (typeof element == "number" || classof2(element) === "Number" || classof2(element) === "String") push2(keys2, toString2(element));
    }
  ...
  if ($stringify) $({ target: "JSON", stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE || !NATIVE_RAW_JSON }, {
    stringify: function stringify2(text, replacer, space) {
...
function requireIsArray$1() {
  ...
  isArray$1 = requireIsArray$2();
  return isArray$1;
}
var isArrayExports$1 = requireIsArray$1();
var _Array$isArray$1 = getDefaultExportFromCjs(isArrayExports$1);
...
function requireGetIteratorMethod$4() {
  ...
  requireEs_array_iterator();
  requireEs_string_iterator();
  var getIteratorMethod2 = requireGetIteratorMethod$5();
...
function requireGetIteratorMethod$3() {
  ...
  var parent = requireGetIteratorMethod$4();
  requireWeb_domCollections_iterator();
...
function requireGetIteratorMethod$2() {
  ...
  var parent = requireGetIteratorMethod$3();
...
function requireGetIteratorMethod$1() {
  ...
  var parent = requireGetIteratorMethod$2();
...
function requireGetIteratorMethod() {
  ...
  getIteratorMethod = requireGetIteratorMethod$1();
  return getIteratorMethod;
}
var getIteratorMethodExports = requireGetIteratorMethod();
var _getIteratorMethod = getDefaultExportFromCjs(getIteratorMethodExports);
var es_array_push = {};
...
function requirePush$5() {
  ...
  var getBuiltInPrototypeMethod2 = requireGetBuiltInPrototypeMethod();
  push$5 = getBuiltInPrototypeMethod2("Array", "push");
  return push$5;
}
var push$4;
...
var pushExports = requirePush();
var _pushInstanceProperty = getDefaultExportFromCjs(pushExports);
...
function requireSlice$6() {
  ...
  var getBuiltInPrototypeMethod2 = requireGetBuiltInPrototypeMethod();
  slice$6 = getBuiltInPrototypeMethod2("Array", "slice");
  return slice$6;
}
var slice$5;
...
function requireSlice$1() {
  ...
  slice$1 = requireSlice$2();
  return slice$1;
}
var sliceExports$1 = requireSlice$1();
var _sliceInstanceProperty$1 = getDefaultExportFromCjs(sliceExports$1);
var es_array_from = {};
var iteratorClose;
...
var _Array$from = getDefaultExportFromCjs(fromExports);
  ...
  $({ target: "Array", proto: true, forced: !HAS_SPECIES_SUPPORT }, {
    splice: function splice2(start, deleteCount) {
      ...
      for (k = 0; k < actualDeleteCount; k++) {
        from2 = actualStart + k;
        if (from2 in O) createProperty2(A, k, O[from2]);
      }
...
function requireGetOwnPropertyDescriptor$2() {
  ...
  var path2 = requirePath();
  var Object2 = path2.Object;
  var $getOwnPropertyDescriptor = getOwnPropertyDescriptor$2.exports = function getOwnPropertyDescriptor2(it, key) {
...
function requireDefineProperties$2() {
  ...
  var path2 = requirePath();
  var Object2 = path2.Object;
  var $defineProperties = defineProperties$2.exports = function defineProperties2(T, D) {
      ...
      forEach2(["add", "clear", "delete", "forEach", "get", "has", "set", "keys", "values", "entries"], function(KEY) {
        ...
        if (KEY in NativePrototype && !(IS_WEAK && KEY === "clear")) {
          createNonEnumerableProperty2(Prototype, KEY, function(a, b) {
            var that = this;
            var collection2 = getInternalState(that).collection;
            if (!IS_ADDER && IS_WEAK && !isObject2(a)) return KEY === "get" ? void 0 : false;
            var result = collection2[KEY](KEY === "forEach" ? function(value, key) {
  ...
  *values() {
  ...
  max(callback) {
    ...
    while (!(curr = iter.next()).done) {
      const _curr$value = _slicedToArray(curr.value, 2), id = _curr$value[0], item = _curr$value[1];
  ...
  min(callback) {
    ...
    while (!(curr = iter.next()).done) {
      const _curr$value2 = _slicedToArray(curr.value, 2), id = _curr$value2[0], item = _curr$value2[1];
      const value = callback(item, id);
      if (value < minValue) {
        minValue = value;
        minItem = item;
  ...
  sort(callback) {
    return new _DataStream({
      [_Symbol$iterator]: () => _getIterator([...this._pairs].toSorted((_ref19, _ref20) => {
        let _ref21 = _slicedToArray(_ref19, 2), idA = _ref21[0], itemA = _ref21[1];
        let _ref22 = _slicedToArray(_ref20, 2), idB = _ref22[0], itemB = _ref22[1];
...
var DataSet = class extends DataSetPart {
  ...
  updateOnly(data, senderId) {
    ...
    const updateEventData = _mapInstanceProperty(_context = _mapInstanceProperty(data).call(data, (update) => {
      ...
      let oldData = _ref.oldData, update = _ref.update;
